...
#include "../components/lcd/csrc/u8g2.h"
...
esp_err_t i2c_write_reg8(uint8_t slaveAddr, uint8_t reg, size_t data_len, const uint8_t *data);
esp_err_t i2c_read_reg8(uint8_t slaveAddr, uint8_t reg, size_t data_len, uint8_t *data);
